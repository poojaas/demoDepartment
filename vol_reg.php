...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 $check = mysql_query("SELECT uname FROM vol_reg WHERE uname = '$usercheck'") 
...
$sql="INSERT INTO vol_reg (uname, pass,name,mob_num,e_mail,msg)
VALUES
...
<form id="form1" name="form1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  <table class="tbl_form" width="461" height="431">
    <tr>
      <td class="cptn" colspan="4"><div align="center">VOLUNTEER REGISTRATION</div></td>
      </tr>
    <tr>
	...
	<a href="vol_login.php" style="background-color:#DCDCDC;border: none;color: crimson;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 20px;margin: 4px 2px;cursor: pointer;" >login</a></td>
	    </tr>
  </table>
  </form>
